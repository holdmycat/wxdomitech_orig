...
Page({
  ...
  onLoad: function (options) {
    ...
    that.setData({
      ...
      curtext: that.data.iteminfo.productdescrip,
  ...
  tabClick: function (e) {
    ...
    switch (tmp) {
      case '0':{
        tmpt = that.data.iteminfo.productdescrip;
        break;
      }
      case '1':{
        tmpt = that.data.iteminfo.productmodule;
        break;
      }
      case '2':{
        tmpt = that.data.iteminfo.productfunction;
        break;
      }
    };
